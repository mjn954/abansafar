...
<head>
    ...
    <title>تورهای خارجی زیارتی | آبان سفر</title>
...
<body>
    ...
    <div class="container py-5">
        ...
        <!-- عنوان صفحه -->
        <h2 class="text-center mb-5">تورهای خارجی زیارتی</h2>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <div class="card-body text-center d-flex flex-column">
                            ...
                            <p class="card-text text-muted text-start mb-4">
                                <strong>مقصد:</strong> {{ e($tour->target) }}<br>
                                <strong>مبدأ:</strong> {{ e($tour->startpoint) }}
                            </p>
                            <a href="{{ route('InternationalPilgrimageTour.show', $tour->id) }}" class="btn btn-outline-primary mt-auto">
                                جزئیات بیشتر
                            </a>
                        </div>
                    </div>
