...
@section('content')
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-3xl shadow-2xl">
        ...
        <form action="{{ route('update.insidetors', $insidetor->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input
                    ...
                    name="title"
                    id="title"
                    value="{{ old('title', $insidetor->title) }}"
            ...
            <div>
                ...
                <input
                    ...
                    name="target"
                    id="target"
                    value="{{ old('target', $insidetor->target) }}"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                    required
                >
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    name="startpoint"
                    id="startpoint"
                    value="{{ old('startpoint', $insidetor->startpoint) }}"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                    required
                >
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    name="price"
                    id="price"
                    value="{{ old('price', $insidetor->price) }}"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                    required
                >
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    required
                >
                    <option value="فعال"   {{ old('status', $insidetor->status) == 'فعال'   ? 'selected' : '' }}>فعال</option>
                    <option value="غیرفعال" {{ old('status', $insidetor->status) == 'غیرفعال' ? 'selected' : '' }}>غیرفعال</option>
                </select>
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="3"
                    required
                >{{ old('plan', $insidetor->plan) }}</textarea>
            </div>

            {{-- مدت اقامت --}}
            <div>
                <label for="duration" class="block mb-1 font-bold text-gray-700">مدت اقامت</label>
                <input
                    type="text"
                    name="duration"
                    id="duration"
                    value="{{ old('duration', $insidetor->duration) }}"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                    required
                >
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="3"
                    required
                >{{ old('hotel_features', $insidetor->hotel_features) }}</textarea>
            </div>
            ...
            <div>
                ...
                @if($insidetor->image)
                    <div class="mt-2">
                        <img src="{{ asset($insidetor->image) }}" alt="تصویر تور" class="w-32 h-32 object-cover rounded">
                    </div>
                @endif
            </div>
