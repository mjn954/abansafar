...
<body>
    ...
    <div class="container py-5">
        ...
        <!-- عنوان صفحه -->
        <h2 class="text-center mb-5">تورهای داخلی</h2>
        ...
        <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <div class="card-body text-center d-flex flex-column">
                            ...
                            <a href="{{ route('DomesticTours.show', $tour->id) }}" class="btn btn-outline-success mt-auto">
                                جزئیات بیشتر
                            </a>
                        </div>
                    </div>
            ...
            @empty
                <div class="col-12 text-center">
                    <p class="text-muted">هیچ تور داخلی‌ای برای نمایش وجود ندارد.</p>
                </div>
            @endforelse
        </div>
